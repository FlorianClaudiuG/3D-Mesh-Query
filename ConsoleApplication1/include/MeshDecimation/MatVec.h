...
Mat4<Scalar> perspective_matrix(Scalar fovy, Scalar aspect, Scalar zNear,
                                Scalar zFar)
{
    Scalar t = Scalar(zNear) * tan(fovy * 3.14159265358979323846 / 360.0);
    Scalar b = -t;
    Scalar l = b * aspect;
    Scalar r = t * aspect;
...
{
    Scalar t = zNear * tan(fovy * 3.14159265358979323846 / 360.0);
    Scalar b = -t;
    Scalar l = b * aspect;
    Scalar r = t * aspect;
...
{
    Scalar ca = cos(angle * (3.14159265358979323846 / 180.0));
    Scalar sa = sin(angle * (3.14159265358979323846 / 180.0));
...
{
    Mat4<Scalar> m(Scalar(0));
    Scalar a = angle * (3.14159265358979323846 / 180.0f);
    Scalar c = cosf(a);
    Scalar s = sinf(a);
